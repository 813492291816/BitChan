"""add bitmessage_onion_services_only to settings_global
...
def upgrade():
    ...
    with op.batch_alter_table("settings_global") as batch_op:
        batch_op.add_column(sa.Column('bitmessage_onion_services_only', sa.Boolean))


def downgrade():
    with op.batch_alter_table("settings_global") as batch_op:
        batch_op.drop_column('bitmessage_onion_services_only')
